    ...
    return (
        <>
            <div className="generate__container">
                <img src={page} alt="page screenshot" className="generate__page--image"></img>
                ...
                <div className="generate__button--clips">
                    <Link to="/create/recommended_clips">
                        <img src={generateButton} alt="generate button" className="generate__button--image"></img>
                    </Link>
                </div>
                <div className="generate__button--next">
                    <button onClick={() => navigate(`/episode-page/publish/${title}/${description}/${seasonNumber}/${episodeNumber}`)} className="next__button">Publish</button>
                </div>
            </div>
        </>
    )
